...
function red_starter_scripts() {   
	...
	wp_enqueue_style( 'font-awesome-style', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.4.0');
...
add_action( 'pre_get_posts', 'sort_shop' );